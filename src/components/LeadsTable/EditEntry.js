...
import { editLeads, getLeads } from "../../actions/leads";
import "./style.css";

export const EditEntry = (props) => {
  const [state, setState] = useState({
    id: props.content.original.id,
    name: props.content.original.name,
    ph_no: props.content.original.ph_no,
    address: props.content.original.address,
  });
  // console.log("row0", state);
